...
<p class="volunteerForm-text">We can also budget some amount of funds for work, but priority will be given to people willing to do at least partially volunteer their time.</p>',
    ...
    'success_title' => 'Form Sumbitted Succesfully',
    'success_description' => '',
    'success_heading' => 'Form Submitted succesfully!',
    'success_lead' => 'Thanks for reaching out.',
    'success_chat_title' => 'Join Our Chat',
    'success_chat_text' => '<p>While waiting for a reply to your submission, why not join the Bitcoin Cash Fund public chat group? This is where we discuss projects, proposals and all things Bitcoin.</p>
<p>We\'re a friendly bunch and we all have one shared mission: to introduce the world to Bitcoin Cash!</p>',
    'success_chat_join_button' => 'Join Us!',
